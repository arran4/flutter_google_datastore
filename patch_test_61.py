...
search = r'''      // Wait, there's a different PopupMenuButton on the screen. Let's explicitly look for the one in the main action bar,
...
replace = r'''      // Open PopupMenu in AppBar
